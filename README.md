...
## After Setup Across All Projects

Now you can manage ESLint rules from a single place:

1. **To make changes**: Update the `kbox-eslint-rules` package
2. **To update all projects**: Run `npm update kbox-eslint-rules` in each project
